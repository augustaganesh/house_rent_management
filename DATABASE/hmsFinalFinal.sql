...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 03, 2021 at 06:01 AM
...
--
-- Table structure for table `admin_bank_ac`
--

CREATE TABLE `admin_bank_ac` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `admin_bank_ac`
--

INSERT INTO `admin_bank_ac` (`id`, `bank_name`, `ac_name`, `ac_no`) VALUES
(2, 'Machhapuchhre Bank', 'Owner Adminn', '32131231231231313');
...
(13, 'Early man', 'admin@gmail.com', '9846597072', '1234');
...
--
-- Indexes for table `admin_bank_ac`
--
ALTER TABLE `admin_bank_ac`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `admin_bank_ac`
--
ALTER TABLE `admin_bank_ac`
