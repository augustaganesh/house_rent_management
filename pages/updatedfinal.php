...
<!--                     <th>Pay this</th>
 -->                </tr>
                <?php foreach($rentList as $key=>$value) : ?>
                <tr>
                    <td><?=++$key;?></td>
                    <td><?=$value['month'];?></td>
                    <td><?=$value['amount'];?></td>
                    ...
                    <td><?php
                        ...
                        <a href="<?=base_url('customer_individual_details.php?action=pay&id='.$value['issue_id']);?>"
           ...
           <?php    if(!isset($_GET['action'])){ ?>  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
                  Pay this
                </button>
            <?php } ?>
                <!-- Modal -->
                    ...
                    <div class="modal-content">
                      ...
                      <form  method="post">
                        <div class="form-group">
                          ...
                          <button type="submit" class="btn btn-primary" name="submit" value="pay">Pay</button>
                        </form>
                    </div>
                   </div>
                  </div>
